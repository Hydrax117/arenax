  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(138,43,226,0.06) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            <p className="font-body text-base text-fg-muted leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
              Discover eFootball Mobile tournaments, compete against the best
              Nigerian players, and win real Naira prizes — straight to your
              bank account.
            </p>
            ...
            <div className="mt-12 flex flex-wrap gap-6 justify-center lg:justify-start">
              {[
                ...
                <div key={label} className="flex flex-col items-center lg:items-start">
                  <span className="font-heading font-black text-2xl text-green glow-green">
                    {value}
                  </span>
...
/** Decorative tournament preview card shown in the hero */
function HeroCard() {
  return (
    <div className="relative">
      ...
      <div className="relative glass-green rounded-2xl overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0d1f15 0%, #0a1a2e 50%, #140a1f 100%)",
          }}
        >
          {/* Arena grid */}
          <div
          ...
          <div className="relative text-center">
            ...
            <p className="font-body text-xs text-fg-muted mt-1 tracking-widest uppercase">
              Championship Finals
            </p>
          </div>
        </div>
        ...
        <div className="p-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <button
              className="text-fg-muted hover:text-green transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
              aria-label="Save tournament"
            >
              ♡
            </button>
          </div>
